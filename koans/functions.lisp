...
(define-test optional-parameters
  (assert-equal (list 42 24 4224) (function-with-optional-parameters 42 24 4224))
  (assert-equal (list 42 24 nil) (function-with-optional-parameters 42 24))
  (assert-equal (list 42 3 nil) (function-with-optional-parameters 42))
  (assert-equal (list 2 3 nil) (function-with-optional-parameters)))
...
(define-test optional-indication
  (assert-equal (list 42 t 24 t) (function-with-optional-indication 42 24))
  (assert-equal (list 42 t 3 nil) (function-with-optional-indication 42))
  (assert-equal (list 2 nil 3 nil) (function-with-optional-indication)))
...
(define-test keyword-parameters ()
  (assert-equal (list :something nil nil) (function-with-keyword-parameters))
...
(define-test funky-parameters
  ...
  (assert-equal (list 1 2 1 nil '(:b 2)) (function-with-funky-parameters 1 :b 2))
  (assert-equal (list 1 2 3 t '(:b 2 :c 3)) (function-with-funky-parameters 1 :b 2 :c 3))
